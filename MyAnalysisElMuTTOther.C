...
Bool_t MyAnalysis::Process(Long64_t entry)
{
    ...
    if((lep1.GetGenId() == -11) && (lep1.GetGenLepDaughterId() == 24 ) && (lep2.GetGenId() == 13) && (lep2.GetGenLepDaughterId() == -24 ))  return kTRUE;
    if((lep1.GetGenId() == 11) && (lep1.GetGenLepDaughterId() == -24 ) && (lep2.GetGenId() == -13) && (lep2.GetGenLepDaughterId() == 24 ))  return kTRUE;
    if((lep1.GetGenId() == -13) && (lep1.GetGenLepDaughterId() == 24 ) && (lep2.GetGenId() == 11) && (lep2.GetGenLepDaughterId() == -24 ))  return kTRUE;
    if((lep1.GetGenId() == 13) && (lep1.GetGenLepDaughterId() == -24 ) && (lep2.GetGenId() == -11) && (lep2.GetGenLepDaughterId() == 24 ))  return kTRUE;
