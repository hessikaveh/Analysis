...
public :
	...
	TH1F* h_pt_lepton_A2BS;
	TH1F* h_eta_lepton_A2BS;
	TH1F* h_pt_Jets_A2BS;	
	TH1F* h_eta_Jets_A2BS;
	TH1F* h_pt_lepton_ATS;
	TH1F* h_eta_lepton_ATS;
	TH1F* h_pt_Jets_ATS;	
	TH1F* h_eta_Jets_ATS;
    ...
    string muonISOSF="ISOEfficienciesAndSF_BCDEF.root";
    string muonIDSF="IDEfficienciesAndSF_BCDEF.root";
    TFile* f_muonISOSF;
    TFile* f_muonIDSF;
    ...
    string egammaSF="egammaEffi.txt_EGM2D.root";
    TFile* f_egammaSF;
    string egammaTkSF="TkegammaEffi.txt_EGM2D.root";
    TFile* f_egammaTkSF;
    string ee_sf="triggerSummary_ee.root";
    TFile* f_ee_sf;
    string em_sf="triggerSummary_emu.root";
    TFile* f_em_sf;

    //GH
    string muonISOSF_GH="ISOEfficienciesAndSF_GH.root";
    string muonIDSF_GH="IDEfficienciesAndSF_GH.root";
    TFile* f_muonISOSF_GH;
    TFile* f_muonIDSF_GH;

    string muonTkSF_GH="Tracking_EfficienciesAndSF_BCDEFGH.root";
    TFile* f_muonTkSF_GH;
    ...
    string phiRes;
    string sfRes;
    string ptResData="Spring16_25nsV6_DATA_PtResolution_AK4PFchs.txt";
    string phiResData="Spring16_25nsV6_DATA_PhiResolution_AK4PFchs.txt";
...
edm::LumiReWeighting LumiWeights_;
	...
	double mc12_weight;
        ...
        double trig_down_weight;
        //ID
        double id_nom_weight;
        double id_up_weight;
        double id_down_weight;
        //ISO
        double iso_nom_weight;
        double iso_up_weight;
        double iso_down_weight;
        //TK
        double tk_nom_weight;
        double tk_up_weight;
        double tk_down_weight;
        //Lepton Selection
        double lepton_nom_weight;
        double lepton_up_weight;
        double lepton_down_weight;

        //PileUp
        edm::LumiReWeighting LumiWeightsUP_;
        edm::LumiReWeighting LumiWeightsDOWN_;
        double pu_nom_weight;
        double pu_up_weight;
        double pu_down_weight;
        //b-tagging
        double b_nom_weight;
        double b_up_weight;
        double b_down_weight;
        //JEC uncertainty
        double jecUnc;
        vector<double> t_bJets_ptUP;
        vector<double> t_bJets_ptDOWN;
