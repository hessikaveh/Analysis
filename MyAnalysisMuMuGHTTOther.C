...
#include "MyAnalysisMuMuGHTTOther.h"
#include <TH2.h>
#include <TStyle.h>
#include <TRandom.h>
#include <TGraph.h>
...
// cout << b_isData << endl;
    ...
    //cout << "lep1 m id"<< lep1.GetGenLepDaughterId() << "mm id" << lep1.GetGenLepMotherId() <<endl;
    //cout << "lep2 m id"<< lep2.GetGenLepDaughterId() << "mm id" << lep2.GetGenLepMotherId() <<endl;
